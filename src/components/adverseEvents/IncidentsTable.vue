    ...
    <div class="card col-span-12">
        ...
        <Toolbar class="mb-6">
            ...
            <template #start>
                ...
                <Button
                    :disabled="feedbackStore.isGlobalLoading || feedbackStore.isDataLoading"
                    label="Добавить"
                    severity="info"
                    icon="pi pi-plus"
                    class="mr-2"
            ...
            <template #end>
                ...
                <Button
                    ...
                    :disabled="feedbackStore.isDataLoading"
                    class="mr-2"
                    @click="renewData"
                />
        ...
        >
            ...
            <Column field="number">
                ...
                <template #body="{ data }">
                    <Skeleton v-if="feedbackStore.isDataLoading"></Skeleton>
...
.status-badge.in_progress {
    background-color: #fef3c7; /* желтый */
    color: #92400e;
    justify-content: center;
}
...
.status-badge.rejected {
    background-color: #fce7f3; /* розовый */
    color: #be185d;
    justify-content: center;
}
