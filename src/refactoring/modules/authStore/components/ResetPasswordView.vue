...
const submitCode = async () => {
    ...
    if (success) {
        ...
        codeError.value = 'Проверьте правильность ввода кода или запросите новый'
        currentStep.value = ResetStep.REQUEST_CODE
    }
}
...
const updatePassword = async () => {
    if (!(await passwordInputRef.value?.validate())) return
