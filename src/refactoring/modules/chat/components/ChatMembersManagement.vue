        ...
        <div class="space-y-4">
            ...
            <div v-if="activeTab === 'members'" class="members-tab">
                ...
                <div class="members-list max-h-96 overflow-y-auto">
                    <div
                        ...
                        :key="member.user.id"
                        class="member-item flex items-center justify-between p-3 border-b border-surface-100 dark:border-surface-700"
                    >
                        <div class="flex items-center gap-3">
            ...
            <div v-if="activeTab === 'settings'" class="settings-tab">
                <div class="space-y-4">
                    ...
                    <div
                        v-if="canEditChat"
                        class="setting-group border-t border-surface-200 dark:border-surface-800 pt-4"
                    >
                        <h4 class="font-semibold mb-3 text-red-600">Опасная зона</h4>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    <h5 class="font-medium text-red-800 dark:text-red-200">
                                        Удалить {{ chatTypeLabel.toLowerCase() }}
                                    </h5>
...
const dialogTitle = computed(() => {
    if (!props.chat) return 'Управление чатом'
    return `Управление: ${props.chat.title}`
})
...
:global(.dark) .invites-list::-webkit-scrollbar-thumb {
